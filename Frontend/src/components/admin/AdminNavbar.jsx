        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/admin/dashboard" className="flex items-center gap-2">
              ...
              <span className="text-white text-xl font-bold">CUET Sphere</span>
            </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:bg-red-600 hover:text-white transition-colors"
              aria-label="Logout"
            >
        ...
        <div className="md:hidden">
          ...
          <div className="pt-4 pb-3 border-t border-gray-700">
            <div className="flex items-center px-5">
              ...
              <button
                onClick={toggleTheme}
                className="ml-auto p-2 rounded-full text-gray-400 hover:text-white"
              >
                {isDark ? <Sun className="h-6 w-6" /> : <Moon className="h-6 w-6" />}
              </button>
            </div>
